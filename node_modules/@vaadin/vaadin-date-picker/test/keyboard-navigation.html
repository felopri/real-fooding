...
if (!ios) {
  describe('keyboard navigation', () => {
    ...
    function focusedDate() {
      return overlayContent.focusedDate;
    }
    ...
    describe('date-picker', () => {
      ...
      it('should not lose focused date after deselecting', () => {
        ...
        expect(focusedDate().getTime()).to.equal(_focused.getTime());
      });
    });
    ...
    describe('overlay', () => {
      ...
      it('should focus one day forward with arrow right', () => {
        arrowRight();
      ...
      it('should focus one day backward with arrow left', () => {
        arrowLeft();
